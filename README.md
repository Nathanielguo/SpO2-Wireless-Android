...
| 首页 | 无线连接 | 实时监测 | 关于 |
| :---: | :---: | :---: | :---: |
| <img src="docs/images/home.png" width="190"> | <img src="docs/images/connect.png" width="190"> | <img src="docs/images/monitor.png" width="190"> | <img src="docs/images/about.png" width="190"> |

- **首页**：标题 + 三个功能入口（无线连接 / 开始监测 / 关于），统一卡片化按钮风格
- **无线连接**：IP / 端口可编辑，带格式校验与错误提示，自动回填上次配置
- **实时监测**：顶部状态指示灯（未连接/连接中/已连接/失败），四路波形卡片，开始/停止切换
- **关于**：软件简介与三步操作说明，卡片化排版

> 仓库内 `docs/preview.html` 为可交互的完整静态预览（含全部页面与配色图例），可直接用浏览器打开查看。上方截图均由该文件渲染生成。
